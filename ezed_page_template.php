...
<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" bgcolor="#FFFFFF">
  <tr> 
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#999999">
          <tr bgcolor="#FFFFFF">
            <td colspan="4"><table border="0" cellpadding="8" cellspacing="0" width="1000">
                ...
                <tr> 
                  <td height="50px"><span class="subhead">Simple2Edit Administration Menu for</span> <span class="style15"><strong><?php echo $_SESSION['site_name']; ?></strong></span><?php if($_SESSION['MM_UserGroup'] == 3) {echo "<br><span class='warning'>You are logged in as an administrator</span>";} ?></td>
                  <td>&nbsp;</td>
                </tr>
            </table></td> 
          </tr>
    ...
    <?php
			 ...
			 <tr><td class="sidenav" height="40px"><div class="sidenavtext" style="margin-left:10px;border-bottom:thin;"><a href="ezed_file_management.php">File management</a></div></td>
			 </tr>
			 <tr><td class="sidenav" height="40px" ><div class="sidenavtext" style="margin-left:10px;border-bottom:thin;"><a href="ezed_image_management.php">Image managment</a></div></td></tr>
			 <tr><td class="sidenav" height="40px" ><div class="sidenavtext" style="margin-left:10px;border-bottom:thin;"><a href="#">Box 4</a></div></td></tr>
			 <tr><td class="sidenav" height="40px" ><div class="sidenavtext" style="margin-left:10px;border-bottom:thin;"><a href="#">Box 5</a></div></td></tr>
			 <tr><td class="sidenav" height="40px"><div class="sidenavtext" style="margin-left:10px;border-bottom:thin;"><a onClick="window.location='<?php echo $logoutAction ?>'" href="#">Logout</a></div></td></tr>
		    </table></td> 
            <td width="0%" valign="top" bgcolor="#DFF1FF">&nbsp;</td>
            <td width="88%" valign="top"><div style="background-color:#DFF1FF; height:5px;"></div><div align="center"><?php include("http://www.studioofdancemedia.com/s2e_help/mainhelp.php"); ?></div></td>
          </tr>
        </table>
