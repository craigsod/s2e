...
CKEDITOR.editorConfig = function( config ) {
	...
	config.extraPlugins = 'colorbutton,mediaembed,tabletools,justify,stylesheetparser,forms,font,filebrowser,image,indent,removeformat,indentblock,jsplusInclude,jsplusBootstrapTools';
