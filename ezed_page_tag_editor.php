...
$getTagPages = mysqli_query($studioAdmin, $query_TagPages);
//$row_getPages = mysqli_fetch_assoc($getPages);
...
$totalSchedules = mysql_num_rows($getSchedules);
        ...
        <table width="100%" height="700px" border="0" cellpadding="0" cellspacing="0" bordercolor="#999999">
          <tr bgcolor="#FFFFFF">
            <td colspan="4"><table border="0" cellpadding="8" cellspacing="0" width="1063">
                ...
                <tr> 
                  <td width="1024" height="50px"><div align="left"><span class="subhead">Page Tag Editor </span> </div>
    ...
    <?php
            ...
            <td width="0%" valign="top" bgcolor="#DFF1FF">&nbsp;</td><td width="88%" valign="top"><div style="background-color:#DFF1FF; height:5px;"></div>
              <blockquote>
                ...
                <?php
				  	while($row_getTagPages = mysqli_fetch_assoc($getTagPages))
					{
						$page_id = $row_getTagPages['page_id'];
						$title = $row_getTagPages['title'];
						$keyword = $row_getTagPages['keywords'];
						$description = $row_getTagPages['description'];
						
						?>
						<div style="height:10px;" >
					  <div id=s<?php echo $page_id; ?> style='display:block; background-color:#FFFFFF; float:left;' onClick='showextra("<?php echo $page_id; ?>");'><span class="sidenavtext"><?php echo $row_getTagPages['name']; ?> - <span style="color:#00CC00";>Show</span></span></div><div id=h<?php echo $page_id; ?> style='display:none; background-color:#FFFFFF; float:left;' onClick='hideextra("<?php echo $page_id; ?>");'><span class="sidenavtext"><?php echo $row_getTagPages['name']; ?> - <span style="color:#CC0000";>Hide</span></span></div>
					  </div><br>
